...
const About = () => {
    return (
        <div
            name="about"
            className="w-full min-h-screen bg-gray-900 text-gray-300 flex items-center justify-center px-6 py-12"
        >
            <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12">
                ...
                <div className="flex justify-center">
                    <img
                        src={profilePic}
                        alt="Profile"
                        className="rounded-2xl w-72 h-72 object-cover border-4 border-cyan-400 shadow-lg shadow-cyan-500/30"
                    />
                </div>
                ...
                <div className="flex flex-col justify-center">
                    ...
                    <div className="mt-6 flex space-x-4">
                        ...
                        <a
                            ...
                            className="px-6 py-3 bg-gray-300 text-gray-900 font-semibold rounded-lg shadow-md hover:bg-gray-400 hover:scale-105 transition duration-300"
                        >
                            View Resume
                        </a>
                        ...
                        <a
                            ...
                            className="px-6 py-3 bg-cyan-400 text-gray-900 font-semibold rounded-lg shadow-md hover:bg-cyan-500 hover:scale-105 transition duration-300"
                        >
                            Download Resume
                        </a>
                    </div>
